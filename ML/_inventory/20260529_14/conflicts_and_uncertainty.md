...
- `0529이용오교수님.txt`: auxiliary transcript exists. Primary pairing used `0529_ml.txt`; auxiliary retained as conflict/secondary source candidate.
